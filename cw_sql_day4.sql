...
INSERT INTO cw_books (book_id, title, author, price, stock)
VALUES
(1, 'Learn SQL', 'John Smith', 400, 10),
(2, 'Mastering Python', 'Jane Doe', 600, 5),
(3, 'HTML & CSS Basics', 'Alan Webb', 300, 8);
...
1)
UPDATE cw_books SET price = price + 50, stock = 12 WHERE title = 'Learn SQL';

2)
UPDATE cw_books SET stock = stock - 2 WHERE price > 500;

3)
DELETE FROM cw_books WHERE book_id = 3;
